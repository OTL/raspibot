...
# install uv4l (http://www.linux-projects.org/modules/sections/index.php?op=viewarticle&artid=14)
# set below config in /etc/uv4l/rv4l-rapicam.conf
#
# encoding = yuv420
#
...
class VisionSensor(object):
    ...
    def __init__(self, image_width=IMAGE_WIDTH, image_height=IMAGE_HEIGHT):
        ...
        self._camera.set(cv2.cv.CV_CAP_PROP_FRAME_HEIGHT, image_height)
